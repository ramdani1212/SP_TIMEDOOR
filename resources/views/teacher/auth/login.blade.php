...
<head>
    ...
    <title>Login Guru Timedoor</title>
    <style>
        body {
        ...
        .logo {
            ...
            margin: 0 auto -10px auto; /* Memusatkan logo dan memberikan jarak bawah */
        }
        h1 {
            color: #66BB6A; /* Hijau yang sedikit berbeda */
            margin-bottom: 25px;
        }
        .form-group {
            margin-bottom: 20px;
...
<body>
    <div class="login-container">
        <img src="{{ asset('images/logo2.png') }}" alt="Timedoor Academy Logo" class="logo">
